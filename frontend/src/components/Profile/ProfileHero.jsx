...
import { PROFILE_DEFAULTS } from './profileData.js'
import SvgProfileDashboard from '../../assets/svg/profile/SvgProfileDashboard.jsx'
        ...
        <div className="profile-hero-info">
          ...
          <div className="profile-hero-facts">
            <span className="profile-hero-fact">
              <PinIcon /> {user?.location || PROFILE_DEFAULTS.location}
            </span>
            <span className="profile-hero-fact">
              <CalendarIcon /> {formatJoinedDate(user?.createdAt)}
            </span>
          </div>
          <p className="profile-hero-bio">{user?.bio || PROFILE_DEFAULTS.bio}</p>
        </div>
      </div>
