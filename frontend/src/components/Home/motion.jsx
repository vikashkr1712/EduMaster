...
export function CountUp({ value }) {
  ...
  // A counter should only run once. On narrow viewports the last stat can sit
  // on an intersection boundary; allowing the observer to toggle there made
  // the value reset and restart continuously.
