...
const contactOptions = [
  ...
  },
  {
    ...
    tint: 'green',
    title: 'Contact Form',
    desc: 'Send account and course questions securely.',
    cta: <Link className="help-contact-btn" to="/contact?subject=Student%20support">Open Form</Link>,
  },
  {
    id: 'phone',
    icon: <PhoneIcon />,
...
const FAQS = [
  {
    ...
    a: 'Go to My Certificates in your dashboard, open an earned certificate, and choose Download PDF.',
  },
  {
  ...
  },
  {
    ...
    a: 'Choose card, UPI, net banking, or wallet during checkout. EduMaster does not store raw payment credentials.',
  },
  {
    q: 'How do I change my password?',
    a: 'Open Settings, enter your current password, then choose and confirm a new password.',
  },
]
    ...
    <DashboardLayout>
      ...
      <DashboardContent>
        ...
        <div className="help-contact-grid">
          {contactOptions.map(({ id, icon, tint, title, desc, cta }) => (
